  ...
  return (
    <div>
      <section ref={homeRef} className='bg-[#f5f5f5] dark:bg-[#141C26] w-[100vw] h-[100vh] flex flex-col items-center justify-center'>
        <div className='w-[100vw] h-[100px] bg-[#141C26] dark:bg-[#f5f5f5] flex items-center gap-[50px] justify-evenly absolute top-0'>
      ...
      <section ref={sobreRef} className='bg-[#f5f5f5] dark:bg-[#141C26] w-[100vw] h-[100vh] flex items-center justify-center'>
        <div className='flex justify-start absolute left-0'>
          <div className='flex flex-col gap-[20px] font-[Tilt_Neon] text-[18px] text-white dark:text-black w-[150px] ml-[20px]'>
            ...
            <button
              onClick={toggleTheme}
              className="border-1 border-gray-700 w-[30px] h-[30px] rounded-full flex items-center justify-center text-white cursor-pointer transition-all duration-300 hover:scale-105 ml-[45px]"
            >
              {theme === 'light' ? (
                <PiSunBold className="w-6 h-6 transition-transform duration-300 rotate-0 fill-[#585e68] dark:fill-[#ebebfd] border-[#585e68] dark:border-[#ebebfd]" />
              ) : (
                <PiMoonBold className="w-6 h-6 transition-transform duration-300 rotate-240 fill-[#585e68] dark:fill-[#ebebfd] border-[#585e68] dark:border-[#ebebfd] border-1 rounded-full" />
              )}
            </button>
          </div>
        </div>
